...
1. [ ] Delete Action Plan templates cloned from PRD

sf project deploy start -o deployment.user@accenture.com.qa --manifest "destructive/destructive-post-refresh/package.xml" --post-destructive-changes "destructive/destructive-post-refresh/destructiveChanges.xml" --wait 10  
...
> sf project deploy start --source-dir bcgov-source --target-org deployment.user@accenture.com.qa --test-level RunLocalTests -g
