...
> Go to Quick find → Sites → click on phocsservices - workspaces → add david user in email repeat same step for phocsportal
...
[ ] EHIS-3247 - this step has to be performed after each PRD deployment 

[ ] Make sure Operator Portal Sharing Sets sharing sets are deployed
