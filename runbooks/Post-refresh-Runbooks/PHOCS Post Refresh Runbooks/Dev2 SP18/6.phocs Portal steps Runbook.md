...
> go to portal - click on workspace - administration - members - add portal profile and ps 
  Permission set - 'PHOCS Operator User CRE PS'.

[x] 2. EHIS-2258

> Go to Quick find → Sites → click on phocsservices → add Vishwa user email in site admin and record owner.
> Go to Quick find → Sites → click on phocsportal → add Vishwa user email in site admin and record owner.

- EMAIL - 'Gandloju.Vishwantha@gov.bc.ca'

[x] PHOCS site publish
...
[ ] Make sure Operator Portal Sharing Sets are deployed
