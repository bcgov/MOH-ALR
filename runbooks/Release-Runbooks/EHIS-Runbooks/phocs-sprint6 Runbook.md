...
1. create below test users with EHIS standard user profileand assign Reporting user PSG to below test users

Interior - InteriorHealth
Fraser - FraserHealth
Vancouver Coastal-Vancouver Coastal Health
Vancouver Island
IslandHealth Island
Northern - Northern Health - NH

2. create one test user with EHIS standard user profile reporting user PG - add this user in all PG's of above and add above 6 PG to EHIS REPORTING USER PG and 

3. Added EHIS PHOCS ALL USER PG TO PHOCS DATA ANALYST PG - record owners should be part of this user

DevOps checklist:

1.Make sure record owners should be part of data analyst PG and reporting users are properly setup