...
2. [ ] Checkout to tag 'QA.522' and create branch out of it `phocs-sprint5` code 
...
[ ] EHIS-1861 - "Give Viewer access to EHIS PHOCS Users PG Group 
...
Import Templates: 
- App Launcher -> OMNISTUDIO - Document Template Designer- Select import on    right top and First Import all Json files 
