...
8. [ ] Populate AAR recordtypeID in PRD for ARR records

9. [ ] Create work area records

10. Deploy Action Plan Templates 

> ActionPlanTemplates-Phocs\main\default

1 . [ ] EHIS-3079 , 3000 , 2865 ,1701 ,2116 , 3093 Action Plan Templates

- Clone the templates in all the sandboxes and publish them and 
- Provide R/W for PHOCS business admin and officer PG , 
- PHOCS operator PG Read, Reporting user group , PHOCS BCCDC Dairy Public Group- Read -   
- Publish Action Plan Templates once deployed
