...
***********************************************************************************************/
trigger ComplaintCaseTrigger on Case (before insert, after insert, after update) {
    ...
    if (Trigger.isAfter && Trigger.isInsert) {
        ComplaintCaseTriggerHandler.handleAfterInsert(Trigger.new);
    }
    if (Trigger.isAfter && Trigger.isUpdate) {
        ComplaintCaseTriggerHandler.handleAfterUpdate(Trigger.new, Trigger.oldMap);
    }
}